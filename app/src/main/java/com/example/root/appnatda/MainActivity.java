...
import com.example.root.appnatda.interfaces.VideoAdapter;

import java.sql.BatchUpdateException;
import java.util.Vector;

public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, Fragmento_1.OnFragmentInteractionListener, Home.OnFragmentInteractionListener, Fragmento_2.OnFragmentInteractionListener,
        Fragmento_3.OnFragmentInteractionListener, ContenedorFragment.OnFragmentInteractionListener,ListaCuentosFragment.OnFragmentInteractionListener, DetalleCuentoFragment.OnFragmentInteractionListener,
        IComunicaFragments {

    ListaCuentosFragment listaFragment;
    DetalleCuentoFragment detalleFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaFragment= new ListaCuentosFragment();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            miFragment = new ListaCuentosFragment();
            fragmentSeleccionado=true;


        }else if(id==R.id.nav_share) {
            miFragment = new Fragmento_3();
            fragmentSeleccionado=true;
    ...
    @Override
    public void enviarCUento(CuentoVo cuento) {

        detalleFragment = new DetalleCuentoFragment();
        Bundle bundleEnvio= new Bundle();
        bundleEnvio.putSerializable("objeto", cuento);
